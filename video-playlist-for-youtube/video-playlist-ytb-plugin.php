...
?>
		...
		<div class="notice notice-success is-dismissible">
			<p><?php esc_attr_e('To view setting please ', 'video-playlist-for-youtube'); ?>
				<a href="<?php echo esc_attr(admin_url('edit.php?post_type=vid_playlist_ytub')); ?>"><?php esc_attr_e('click here', 'video-playlist-for-youtube'); ?></a>
			</p>
		</div>
	<?php
	...
	<table id="repeatable-fieldset-one" width="100%">
		<tbody class="ytub-sortble">
			...
			?>
				...
				<tr class="drgble-sect">
					<td>
						<input type="text" required="required" placeholder="Title" title="Title" name="TitleItem[]" />
					</td>
					<td>
 ...
 * @return $links [array]
 */
function vpfy_add_custom_plugin_links($links, $file) {
...
add_filter( 'plugin_row_meta', 'vpfy_add_custom_plugin_links', 10, 2);